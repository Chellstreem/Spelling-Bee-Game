...
public class SpawnableObjectPool : IPoolInitializable, IEventSubscriber<OnReturnedToPool>, ISpawnableObjectProvider
{
    private SpawnableObjectCollection collection;
